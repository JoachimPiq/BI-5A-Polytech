...
/**
 * Job: Test_Crimes Purpose: <br>
 * Description: Test sur les données des crimes et des districts <br>
 * 
 * @author user@talend.com
 * @version 7.2.1.20190620_1446
 * @status
 */
public class Test_Crimes implements TalendJob {
	...
	private final String jobName = "Test_Crimes";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Test_Crimes.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class crimes_outputStruct implements routines.system.IPersistableRow<crimes_outputStruct> {
		final static byte[] commonByteArrayLock_BI5A_Test_Crimes = new byte[0];
		static byte[] commonByteArray_BI5A_Test_Crimes = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_BI5A_Test_Crimes.length) {
					if (length < 1024 && commonByteArray_BI5A_Test_Crimes.length == 0) {
						commonByteArray_BI5A_Test_Crimes = new byte[1024];
					} else {
						commonByteArray_BI5A_Test_Crimes = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_BI5A_Test_Crimes, 0, length);
				strReturn = new String(commonByteArray_BI5A_Test_Crimes, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_BI5A_Test_Crimes) {
	...
	public void tFileInputDelimited_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// linked node: tMap_1 - inputs:(row2,row4) outputs:(crimes_output)
...
// Start of branch "row4"
	...
	public static void main(String[] args) {
		final Test_Crimes Test_CrimesClass = new Test_Crimes();

		int exitCode = Test_CrimesClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Test_Crimes.class.getClassLoader()
					.getResourceAsStream("bi5a/test_crimes_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Test_Crimes.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Test_Crimes");
		}
...
/************************************************************************************************
 * 143891 characters generated by Talend Open Studio for Data Integration on the
 * 26 octobre 2021 16:49:14 CEST
 ************************************************************************************************/