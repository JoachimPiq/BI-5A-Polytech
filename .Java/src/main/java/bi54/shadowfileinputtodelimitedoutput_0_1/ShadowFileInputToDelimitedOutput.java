...
package bi54.shadowfileinputtodelimitedoutput_0_1;
...
public class ShadowFileInputToDelimitedOutput implements TalendJob {
	...
	public static class RowStruct implements routines.system.IPersistableRow<RowStruct> {
		final static byte[] commonByteArrayLock_BI54_ShadowFileInputToDelimitedOutput = new byte[0];
		static byte[] commonByteArray_BI54_ShadowFileInputToDelimitedOutput = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_BI54_ShadowFileInputToDelimitedOutput.length) {
					if (length < 1024 && commonByteArray_BI54_ShadowFileInputToDelimitedOutput.length == 0) {
						commonByteArray_BI54_ShadowFileInputToDelimitedOutput = new byte[1024];
					} else {
						commonByteArray_BI54_ShadowFileInputToDelimitedOutput = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_BI54_ShadowFileInputToDelimitedOutput, 0, length);
				strReturn = new String(commonByteArray_BI54_ShadowFileInputToDelimitedOutput, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_BI54_ShadowFileInputToDelimitedOutput) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited = (new java.io.File(
						"D:/Documents_Joachim/Ecole/4eme_Annee/Cours/Buisness_Inteligence/TOS_DI-20190620_1446-V7.2.1/workspace/BI-5A/BI54/temp/preview/Marijuana_Data.csv"))
				...
				try {
					...
					Object filename_tFileInputDelimited = "D:/Documents_Joachim/SyncFolder/Cours_5A/BI/Intégration/data/Marijuana_Data.csv";
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ShadowFileInputToDelimitedOutput.class.getClassLoader().getResourceAsStream(
					"bi54/shadowfileinputtodelimitedoutput_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 48872 characters generated by Talend Open Studio for Data Integration on the
 * 2 novembre 2021 à 17:37:49 CET
 ************************************************************************************************/