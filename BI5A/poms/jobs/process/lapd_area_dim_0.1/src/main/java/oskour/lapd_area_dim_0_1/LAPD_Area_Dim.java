...
package oskour.lapd_area_dim_0_1;
...
public class LAPD_Area_Dim implements TalendJob {
	...
	public static class SortiAreaDimensionStruct implements routines.system.IPersistableRow<SortiAreaDimensionStruct> {
		final static byte[] commonByteArrayLock_OSKOUR_LAPD_Area_Dim = new byte[0];
		static byte[] commonByteArray_OSKOUR_LAPD_Area_Dim = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_OSKOUR_LAPD_Area_Dim.length) {
					if (length < 1024 && commonByteArray_OSKOUR_LAPD_Area_Dim.length == 0) {
						commonByteArray_OSKOUR_LAPD_Area_Dim = new byte[1024];
					} else {
						commonByteArray_OSKOUR_LAPD_Area_Dim = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_OSKOUR_LAPD_Area_Dim, 0, length);
				strReturn = new String(commonByteArray_OSKOUR_LAPD_Area_Dim, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_OSKOUR_LAPD_Area_Dim) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						"C:/Users/roro1/Documents/5A_INFO/Projet BI/ETL/BI-5A-Polytech/data/Outputs/LAPD_Area_Output.csv"))
				...
				if (filetFileOutputDelimited_1.length() == 0) {
					outtFileOutputDelimited_1.write("AREA");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("AREA_NAME");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("NbArrestationPossessionCanabis");
...
// ------------
				...
				try {
					...
					Object filename_tFileInputDelimited_2 = "C:/Users/roro1/Documents/5A_INFO/Projet BI/ETL/BI-5A-Polytech/data/Inputs/Marijuana_Data.csv";
					...
					try {
						fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Users/roro1/Documents/5A_INFO/Projet BI/ETL/BI-5A-Polytech/data/Inputs/Marijuana_Data.csv",
...
// Start of branch "row3"
					...
					if (!((Object) ("C:/Users/roro1/Documents/5A_INFO/Projet BI/ETL/BI-5A-Polytech/data/Inputs/Marijuana_Data.csv") instanceof java.io.InputStream)) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = LAPD_Area_Dim.class.getClassLoader()
					.getResourceAsStream("oskour/lapd_area_dim_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 160965 characters generated by Talend Open Studio for Data Integration on the
 * 17 novembre 2021 15:23:35 CET
 ************************************************************************************************/