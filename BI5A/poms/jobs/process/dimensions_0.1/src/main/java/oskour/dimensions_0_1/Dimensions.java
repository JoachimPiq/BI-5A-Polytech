...
public class Dimensions implements TalendJob {
	...
	public static class row10Struct implements routines.system.IPersistableRow<row10Struct> {
		final static byte[] commonByteArrayLock_OSKOUR_Dimensions = new byte[0];
		static byte[] commonByteArray_OSKOUR_Dimensions = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_OSKOUR_Dimensions.length) {
					if (length < 1024 && commonByteArray_OSKOUR_Dimensions.length == 0) {
						commonByteArray_OSKOUR_Dimensions = new byte[1024];
					} else {
						commonByteArray_OSKOUR_Dimensions = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_OSKOUR_Dimensions, 0, length);
				strReturn = new String(commonByteArray_OSKOUR_Dimensions, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_OSKOUR_Dimensions) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						"C:/Users/roro1/Documents/5A_INFO/Projet BI/ETL/BI-5A-Polytech/data/Outputs/crimeOutput.csv"))
				...
				fileName_tFileOutputDelimited_2 = (new java.io.File(
						"C:/Users/roro1/Documents/5A_INFO/Projet BI/ETL/BI-5A-Polytech/data/Outputs/Weapon_output.csv"))
								.getAbsolutePath().replace("\\", "/");
				...
				fileName_tFileOutputDelimited_3 = (new java.io.File(
						"C:/Users/roro1/Documents/5A_INFO/Projet BI/ETL/BI-5A-Polytech/data/Outputs/Crime_codes_output.csv"))
								.getAbsolutePath().replace("\\", "/");
				...
				fileName_tFileOutputDelimited_5 = (new java.io.File(
						"C:/Users/roro1/Documents/5A_INFO/Projet BI/ETL/BI-5A-Polytech/data/Outputs/Day_output.csv"))
								.getAbsolutePath().replace("\\", "/");
				...
				fileName_tFileOutputDelimited_6 = (new java.io.File(
						"C:/Users/roro1/Documents/5A_INFO/Projet BI/ETL/BI-5A-Polytech/data/Outputs/Time_output.csv"))
								.getAbsolutePath().replace("\\", "/");
				...
				fileName_tFileOutputDelimited_7 = (new java.io.File(
						"C:/Users/roro1/Documents/5A_INFO/Projet BI/ETL/BI-5A-Polytech/data/Outputs/Victim_output.csv"))
								.getAbsolutePath().replace("\\", "/");
...
// ###############################
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */
						"C:/Users/roro1/Documents/5A_INFO/Projet BI/ETL/BI-5A-Polytech/data/Inputs/Crime_Data_from_2010_to_2019.csv"/**
																																	 * End
																																	 * field
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					Object filename_tFileInputDelimited_2 = "C:/Users/roro1/Documents/5A_INFO/Projet BI/ETL/BI-5A-Polytech/data/Inputs/Crime_District.csv";
					...
					try {
						fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Users/roro1/Documents/5A_INFO/Projet BI/ETL/BI-5A-Polytech/data/Inputs/Crime_District.csv",
...
// Start of branch "row4"
					...
					if (!((Object) ("C:/Users/roro1/Documents/5A_INFO/Projet BI/ETL/BI-5A-Polytech/data/Inputs/Crime_District.csv") instanceof java.io.InputStream)) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Dimensions.class.getClassLoader()
					.getResourceAsStream("oskour/dimensions_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 286665 characters generated by Talend Open Studio for Data Integration on the
 * 17 novembre 2021 15:26:39 CET
 ************************************************************************************************/