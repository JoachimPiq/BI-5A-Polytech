...
public class Dimensions implements TalendJob {
	...
	public static class row10Struct implements routines.system.IPersistableRow<row10Struct> {
		final static byte[] commonByteArrayLock_BI54_Dimensions = new byte[0];
		static byte[] commonByteArray_BI54_Dimensions = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_BI54_Dimensions.length) {
					if (length < 1024 && commonByteArray_BI54_Dimensions.length == 0) {
						commonByteArray_BI54_Dimensions = new byte[1024];
					} else {
						commonByteArray_BI54_Dimensions = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_BI54_Dimensions, 0, length);
				strReturn = new String(commonByteArray_BI54_Dimensions, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_BI54_Dimensions) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						"D:/Documents_Joachim/SyncFolder/Cours_5A/BI/Intégration/data/crimeOutput.csv"))
				...
				fileName_tFileOutputDelimited_2 = (new java.io.File(
						"D:/Documents_Joachim/SyncFolder/Cours_5A/BI/Intégration/data/Weapon_output.csv"))
								.getAbsolutePath().replace("\\", "/");
				...
				fileName_tFileOutputDelimited_3 = (new java.io.File(
						"D:/Documents_Joachim/SyncFolder/Cours_5A/BI/Intégration/data/Crime_output.csv"))
								.getAbsolutePath().replace("\\", "/");
				...
				fileName_tFileOutputDelimited_5 = (new java.io.File(
						"D:/Documents_Joachim/SyncFolder/Cours_5A/BI/Intégration/data/Day_output.csv"))
								.getAbsolutePath().replace("\\", "/");
				...
				fileName_tFileOutputDelimited_6 = (new java.io.File(
						"D:/Documents_Joachim/SyncFolder/Cours_5A/BI/Intégration/data/Time_output.csv"))
								.getAbsolutePath().replace("\\", "/");
				...
				fileName_tFileOutputDelimited_7 = (new java.io.File(
						"D:/Documents_Joachim/SyncFolder/Cours_5A/BI/Intégration/data/Victim_output.csv"))
								.getAbsolutePath().replace("\\", "/");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					Object filename_tFileInputDelimited_2 = "D:/Documents_Joachim/SyncFolder/Cours_5A/BI/Intégration/data/Crime_District.csv";
					...
					try {
						fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited(
								"D:/Documents_Joachim/SyncFolder/Cours_5A/BI/Intégration/data/Crime_District.csv",
...
// Start of branch "row4"
					...
					if (!((Object) ("D:/Documents_Joachim/SyncFolder/Cours_5A/BI/Intégration/data/Crime_District.csv") instanceof java.io.InputStream)) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Dimensions.class.getClassLoader()
					.getResourceAsStream("bi54/dimensions_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 286223 characters generated by Talend Open Studio for Data Integration on the
 * 1 novembre 2021 à 18:35:54 CET
 ************************************************************************************************/